...
import blog1 from '../../../src/assets/clients/blog1Happy_Hol.jpg'
import {
  ArrowLeft, Calendar, User, Eye, MessageCircle, Share2, Bookmark, ThumbsUp, Home,
  Facebook, Twitter, Linkedin, Link, Send, Heart, Reply
} from 'lucide-react';
const BlogDetailPage = () => {
  ...
  // Blog posts data from BlogSection
  const blogPosts = [
    {
      id: 1,
...
<p class='text-[18px] text-black'>These are just a few of the many customer-friendly features incorporated into LivetourPRO. Tour executives can work around the features and customize it to their wish and fancy. Livetour promises better customer relationship management. It takes just a few minutes to build an itinerary whereas traditionally it took travel executives days to arrange a budget tour.</p>
    ...
    },
    {
      ...
      fullContent: `
       ...
       <p class='text-[18px] text-black'>Let’s take a quick look into some of the features that make LivetourPRO an industry first. Any client will require to follow up process for a successful tour. There are many options available to record the progress of the enquiry. The follow-up section comes with this ability to take the enquiry forward according to the comfort of the client. The following are the options available for the follow up of any enquiry.</p>
        <h3 class="text-xl font-semibold mt-6 mb-2 text-red-600">Drafted Itineraries</h3>
       <p class='text-[18px] text-black'>Once an enquiry is processed... actions like update enquiry, close enquiry, view edited versions and feedback.</p>
...
<p class='text-[18px] text-black'>LivetourPRO is a complete medley of features helping the tour organizer craft the perfect itinerary. One major feature is the itinerary builder that puts together the destination, properties, vehicles, and houseboat cruises at custom prices helping the client decide every detail regarding the tour. An itinerary can be built in two ways, one through the itinerary builder button and another through the convert to lead option available in the latest enquiry section. Either way, the itinerary is built on all important info available for personal as well as the tour.</p>
       ...
       <h3 class="text-[24px] font-semibold text-red-600 mt-6 mb-2">Guest Info</h3>
        <p class='text-[18px] text-black'>This is the first tab for the details. The form displayed contains details such as personal details, arrival and departure cities and dates, follow up dates, package name, details, and agents. Upon saving the itinerary details are recorded on the page for the itinerary builder.
...
It all starts with the add enquiry button on the manage enquiries page with a tab called latest enquiries bringing you to a form with the details to be added like personal info, tour dates and arrival, and departure cities, number of travelers and the destination, enquiry date, and reminder. On completing the form, the enquiry is listed under the latest enquiry section.</p>
 ...
 <p className="text-gray-800 text-[18px] mb-4">
  ...
  <ul className="list-disc pl-5 space-y-2 text-[18px] text-gray-800">
    <li>
      <strong>Close enquiry:</strong> In case the enquiry is not genuine, the admin can close the enquiry then and there. No further operations are possible for this enquiry.
    </li>
    <li>
      <strong>Send quote/assign:</strong> This section is used to send the quote of the tour and also to assign the follow up to the travel executives who will be communicating the details to the traveler.
    </li>
    <li>
      <strong>Convert to new lead:</strong> In case the enquiry proceeds to booking, the assigned executive can send the itinerary through this section and eventually convert it to the new lead.
    </li>
    <li>
      <strong>Remarks:</strong> Adding remarks is important in case the client has requirements like dietary restrictions or any other specifications.
    </li>
  </ul>
  ...
  <ul className="list-disc pl-5 space-y-2 text-[18px] text-gray-800">
    <li>
      <p class='text-black'>Delete:</p> The whole enquiry can be deleted once there is no response or when identifying it as a spam enquiry. The whole enquiry details are erased from the database.
    </li>
    <li>
      <strong>Enquiry details /assign:</strong> This section makes editing easy for the assigned executive. A popup with the enquiry details is displayed. The executive can be intimidated by assigning from this section also.
    </li>
    <li>
      <strong>Remarks:</strong> Helps jot down any suggestions or reminders to help the other executives take a detailed study about any matter.
    </li>
 ...
 <ul className="list-disc pl-5 space-y-2 text-[18px] text-gray-800">
    <li>
      <p class='text-black'>Enquiry details:</p> This action helps the executive to view the itinerary details and view the status of the quote, whether it is sent or not.
    </li>
    <li>
      <strong>View itinerary:</strong> Viewing the itinerary is enabled from this selection. It redirects to the itinerary builder page to make any last-minute changes to the tour in case there are some discrepancies in the reservations.
    </li>
    <li>
      <strong>Remark</strong>  Recording any comments from the client to be noted while planning the tour.
    </li>

  </ul>

   <h3 class="text-[24px] font-semibold text-red-600 mt-6 mb-2">Closed Itinerary</h3>
     <p class='text-[18px] text-black'>Just as the name suggests, the enquiry can be closed once there is no proeeding in the communication. The enquiry is closed from the latest enquiry page but listed under the closed enquiry tab. No further action is possible regarding a closed enquiry.
 </p>
  <p class='text-[18px] text-black'>Actions</p>
  <ul className="list-disc pl-5 space-y-2 text-[18px] text-gray-800">
    <li>
      <p class='text-black'>Delete:</p> The enquiry can be completely deleted to keep it from interfering with other enquiries. This makes the database lighter without unnecessary additions.
    </li>
    <li>
      <strong>Enquiry details:</strong> This helps in just browsing through the enquiry details to not duplicate the details or to keep an account of spam enquiries.
    </li>
    <li>
      <strong>Remarks:</strong> Helps jot down any suggestions or reminders to help the other executives take a detailed study about any matter.
    </li>
...
Agent management is an issue that every tour company faces. The company must make sure every agent is taken into consideration along with the transactions and debit and credit details
 ...
 <p className="text-gray-800 text-[18px] mb-4">
Houseboats are a vital inclusion in all the tour packages. Managing them poses a major hurdle in arranging tours. With the resource management feature, LivetourPRO makes this as simple as a child’s play. The rates are displayed in the itinerary builder.  </p>
<h3 class="text-[24px] font-semibold text-red-600 mt-6 mb-2">LivetourPRO: A Jack Of All Trades
</h3>
 <p className="text-gray-800 text-[18px] mb-4">
With LivetourPRO, you have a strong grasp over your business with records on all aspects. Be it resource management or CRM services, there is no place for any flaw. Your business is made as professional as it can be with the best software solution. With prompt customer service, Livetour is the answer to all your business needs keeping a record of whatever customer queries come your way. </p>
    ...
    },
    {
      ...
      readTime: "7 min read",
      fullContent: `
        <p class='text-[18px] text-black'>Travel companies are competing with each other to bring the best services to travelers. Getting the whole process of booking and reservation automated helps reduce the burden of paperwork for the company. This is why tour management systems are in high demand. A good travel company gives you a detailed itinerary and lets you have an insight into how much you will have to spend and what facilities will be provided. LivetourPRO is not just any other software, but surely it has made a mark of its own in the travel technology industry. The software is as robust as it should be providing the best solution regarding bookings, reservations, agent management and all the aspects related to organizing a trip.</p>
       <h3 class="text-[24px] font-semibold text-red-600 mt-6 mb-2">Resource Management In LivetourPRO: A Feature Beyond Words
</h3>
        <p class='text-[18px] text-black'>LivetourPRO has a good resource management feature that helps manage agents, vehicles, hotels, houseboats and even more within minutes. It lets the travel company schedule the agents by season and rates. You get the quotes within minutes and there is no fumbling around with the contract. It is all done in a matter of seconds. The software is well approved by a wide range of travel companies.
 ...
 You can manage your properties with the seasonal rates as bulk or individually. This makes it easy for you to get the contracts with agents quickly.
   ...
   <h3 class="text-[24px] font-semibold text-red-600 mt-6 mb-2">Manage Vehicles With Their Pricing
</h3>
 <p className="text-gray-800 text-[18px] mb-4">
LivetourPRO enables vehicle management with its price calculation. The system gives an automatic price calculation in the itinerary builder.
  </p>
   <h3 class="text-[24px] font-semibold text-red-600 mt-6 mb-2">Get Your Best Quote With The Agent</h3>
 <p className="text-gray-800 text-[18px] mb-4">
Agent management is an issue that every tour company faces. The company must make sure every agent is taken into consideration along with the transactions and debit and credit details
...
With LivetourPRO, you have a strong grasp over your business with records on all aspects. Be it resource management or CRM services, there is no place for any flaw. Your business is made as professional as it can be with the best software solution. With prompt customer service, LivetourPRO is the answer to all your business needs keeping a record of whatever customer queries come your way. </p>
  ...
  const getRelatedArticles = (currentPost) => {
    if (!currentPost) return [];
    // Filter out current post and get 4 related articles
    const otherPosts = blogPosts.filter(p => p.id !== currentPost.id);
    // Prioritize posts from same category, then get random others
    const sameCategoryPosts = otherPosts.filter(p => p.category === currentPost.category);
    const otherCategoryPosts = otherPosts.filter(p => p.category !== currentPost.category);
    const related = [...sameCategoryPosts, ...otherCategoryPosts].slice(0, 4);
    return related;
  };
  const relatedArticles = getRelatedArticles(post);
  const handleRelatedArticleClick = (relatedPost) => {
    navigate(`/blogs/${relatedPost.id}`);
  ...
  const renderContent = (content) => {
    ...
    // Handle both fullContent (HTML) and content (markdown-style text)
    ...
    return paragraphs.map((paragraph, index) => {
      if (paragraph.startsWith('**') && paragraph.endsWith('**')) {
        // Handle bold headers
        return (
          <h3 key={index} className="text-2xl font-bold text-red-600 mt-8 mb-4">
            {paragraph.replace(/\*\*/g, '')}
          </h3>
        );
      } else if (paragraph.startsWith('*') && paragraph.endsWith('*')) {
        // Handle italic headers
        return (
          <h4 key={index} className="text-xl font-semibold text-red-600 mt-6 mb-3">
            {paragraph.replace(/\*/g, '')}
          </h4>
        );
      } else {
        // Regular paragraphs
        return (
          <p key={index} className="text-black text-[18px] leading-relaxed mb-4">
        ...
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <button
              ...
              className={`p-2 rounded-full transition-all hover:bg-red-100 ${liked ? 'text-red-600 bg-red-50' : 'text-gray-500'
                }`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-full transition-all hover:bg-blue-100 ${bookmarked ? 'text-blue-600 bg-blue-50' : 'text-gray-500'
                }`}
            >
            ...
            <div className="relative">
              <button
                ...
                className="p-2 rounded-full text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition-all"
              >
                <Share2 className="w-5 h-5" />
              </button>

              {showShareMenu && (
                <div className="absolute right-0 z-20 mt-2 w-52 rounded-lg shadow-lg bg-white border border-gray-200 animate-fade-in">
                  {[
      ...
      <div className="relative h-[810px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          <div className="max-w-4xl mx-auto text-white">
            <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium mb-4 ${post.categoryColor}`}>
              {post.category}
            </span>
        ...
        <article className="max-w-4xl mx-auto py-12">
          ...
          <div className="flex items-center space-x-4 mb-12 pb-8 border-b border-gray-200">
            ...
            <div>
              ...
              <div className="text-gray-800">Travel Technology Experts</div>
              <div className="text-[15px] text-gray-800">Published on {post.date}</div>
            </div>
          </div>
          {/* Article Content */}
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">
              {post.excerpt}
              <h1 className="text-3xl md:text-[30px] font-bold mb-4 leading-tight text-red-600">{post.title}</h1>
            </p>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            ...
            <div className="flex flex-wrap gap-3">
              {['LivetourPRO', 'Travel Management', 'Tour Packages', 'CRM', 'Automation'].map((tag) => (
                <span key={tag} className="px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm hover:bg-blue-100 transition-colors cursor-pointer border border-blue-200">
                  #{tag}
                </span>
              ))}
            </div>
          </div>
          {/* Comments Section - Only shown when showComments is true */}
          {showComments && (
            <div className="mt-16 pt-8 border-t border-gray-200">
              ...
              {/* Comment Form */}
              <form onSubmit={handleCommentSubmit} className="mb-12 bg-gray-50 rounded-xl p-6">
                <div className="flex space-x-4">
                  ...
                  <div className="flex-1">
                    <textarea
                      ...
                      className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none bg-white shadow-sm"
                      rows="3"
                    />
                    <div className="flex justify-end mt-2">
                      <button
                        ...
                        className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center font-medium"
                      >
                        ...
                        {comment.replies && comment.replies.length > 0 && (
                          <div className="mt-4 space-y-4">
                            {comment.replies.map((reply) => (
                              <div key={reply.id} className="flex items-start space-x-3 bg-gray-50 rounded-lg p-4 border border-gray-100">
                                <img
                                  src={reply.avatar}
                                  alt={reply.author}
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {relatedArticles.map((relatedPost) => (
                <div
                  key={relatedPost.id}
                  onClick={() => handleRelatedArticleClick(relatedPost)}
                  className="group cursor-pointer bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium text-white ${relatedPost.categoryColor}`}>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      ...
                      <span className="text-blue-600 font-medium">{relatedPost.readTime}</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="mt-16 text-center">
            <button
              onClick={() => navigate('/blog')}
              className="bg-red-600 text-white px-8 py-3 rounded-full hover:bg-red-700 cursor-pointer transition-colors font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              View All Articles
            </button>
          </div>
