...
import twitter from '../assets/img/footer/x.png';
import linkedIn from '../assets/img/footer/linkedin.png';
import facebook from '../assets/img/footer/facebook.png';
import youtube from '../assets/img/footer/youtube.png';
import instagrm from '../assets/img/footer/instagram.png';
      ...
      <div className="text-[20pxpx]">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 px-4 py-8">
          ...
          <div>
            ...
            <img
              ...
              alt="Webinar"
              className="w-40 sm:w-52 mt-3 rounded-2xl"
            />
          </div>
          ...
          <div>
            ...
            <h4 className="font-semibold text-base mt-5">Follow Us On</h4>
            <div className="flex flex-wrap gap-3 mt-2 object-contain">
              {[
                ...
                >
                  <img src={item.icon} className="w-8 h-8 border rounded-sm object-contain p-1.5" alt={`Social ${i}`} />
                </a>
              ))}
            </div>
        ...
        <div className="border-t border-gray-700 py-6 px-4">
          <div className="max-w-4xl mx-auto w-full">
            <div className="flex flex-wrap text-sm justify-center items-center gap-3 sm:gap-4 text-center">
              {[
                { label: 'Home', path: '/' },
                { label: 'Contact Us', path: '/contactUs' },
            ...
            {/* Copyright */}
            <div className="mt-4 flex flex-col sm:flex-row justify-center items-center gap-3 text-center text-sm">
